const navigation = {
	solutions: [
		{ name: 'Démarches', href: '#' },
		{ name: 'Tutoriels', href: '#' },
		{ name: 'Assistant virtuels', href: '#' },
		{ name: 'Assistant téléphonique', href: '#' },
	],
	support: [
			...
			<div className="mx-auto max-w-screen-2xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="grid grid-cols-2 gap-8 xl:col-span-2">
						...
						<div className="md:grid md:grid-cols-2 md:gap-8">
							...
							<div className="mt-12 md:mt-0">
								<h3 className="text-base font-medium text-gray-900">Légale</h3>
								<ul role="list" className="mt-4 space-y-4">
					...
					<div className="mt-8 xl:mt-0">
						...
						<p className="mt-4 text-base text-white">
							Les dernier(è)s articles, nouveautés et ressources envoyer chaque
							semaine par mail.
						</p>
						<form className="mt-4 sm:flex sm:max-w-md">
							...
							<div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
								<button
									type="submit"
									className="flex w-full items-center justify-center rounded-md border border-transparent bg-white py-2 px-4 text-base font-medium text-indigo-600 hover:bg-gray-300 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
								>
									Abonnez-vous
								</button>
							</div>
				...
				<div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
					...
					<p className="mt-8 text-base text-white md:order-1 md:mt-0">
						&copy; 2022 Lotura. Site pédagogique sans but commerciale.
					</p>
				</div>
			</div>
		</footer>
